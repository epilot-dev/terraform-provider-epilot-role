...
# 	curl https://docs.api.epilot.io/permissions.yaml > original.yaml
...
# 	curl https://docs.api.epilot.io/permissions.yaml > $(TMP)/openapi.yaml
...
original.yaml:
	cp permissions.yaml original.yaml
...
# curl https://docs.api.epilot.io/workflows-definition.yaml > $(TMP)/openapi.yaml
	cp permissions.yaml $(TMP)/openapi.yaml
	speakeasy overlay apply -s $(TMP)/openapi.yaml -o overlay.yaml > $(TMP)/final.yaml
	speakeasy generate sdk --lang terraform -o . -s $(TMP)/final.yaml
