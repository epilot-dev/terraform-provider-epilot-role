...
// Generated from OpenAPI doc version 1.2.0 and generator version 2.855.2
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.21.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.21.0 2.855.2 1.2.0 github.com/epilot-dev/terraform-provider-epilot-role/internal/sdk",
