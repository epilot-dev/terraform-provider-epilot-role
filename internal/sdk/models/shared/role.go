...
type RolePayload struct {
	...
	PartnerRoleSchemas1 *PartnerRoleSchemas1 `queryParam:"inline" union:"member"`
...
func (u *RolePayload) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &partnerRoleSchemas1, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  RolePayloadTypePartnerRoleSchemas1,
			Value: &partnerRoleSchemas1,
		})
	}
	...
	case RolePayloadTypeShareRoleSchemas1:
		...
		return nil
	case RolePayloadTypePartnerRoleSchemas1:
		u.PartnerRoleSchemas1 = best.Value.(*PartnerRoleSchemas1)
		return nil
