...
func newVisualisations(sdkConfig sdkConfiguration) *Visualisations {
...
func (s *Visualisations) ListAvailableVisualisations(ctx context.Context, opts ...operations.Option) (*operations.ListAvailableVisualisationsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/dashboard/visualisations")
	if err != nil {
	...
	res := &operations.ListAvailableVisualisationsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListAvailableVisualisationsResponseBody
